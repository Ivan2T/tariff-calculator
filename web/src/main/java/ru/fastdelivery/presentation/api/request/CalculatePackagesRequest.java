...
public record CalculatePackagesRequest(
        ...
        @Schema(description = "Список упаковок отправления",
                example = "[{\"weight\": 4056.45, \"dimensions\": {\"length\":100,\"width\":50,\"height\":30}}]")
        @NotNull @NotEmpty
        ...
        @Schema(description = "Координаты точки отправления")
        @NotNull
        GeoPoint from,

        @Schema(description = "Координаты точки назначения")
        @NotNull
        GeoPoint to
) {}